...
#ifndef DIRECTEDGRAPH_ADJACENCYLIST_H
#define DIRECTEDGRAPH_ADJACENCYLIST_H

#endif //DIRECTEDGRAPH_ADJACENCYLIST_H
...
//有向图的邻接表结构的广度优先遍历算法需要利用到的队列结构(循环队列的顺序存储结构)
 typedef struct {
     int data[10];
     int front;  //头指针
